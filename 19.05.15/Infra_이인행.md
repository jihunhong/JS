...
- 개발자로부터의 기능적 요건, 액세스 수나 사용자 수 등의 목표 수치, 관련 행정기관이나 법률 등의 대응과 같은 것들을 고려하여 선정한다.
...
- 카탈로그 스펙의 70~80%가 실측값으로 나온다는 가정하에, 상위의 회선 대역이나 방화벽을 선정할 경우 카탈로그 스펙이 최소한 150Mbps가 되는 제품을 선정하는 것이 좋다.
